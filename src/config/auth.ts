// T-Buddy（consumer）SSO 設定中心。只讀 env，集中管理「對接 auth 所需的最少資訊」。
...
export const tpass = createTpassNextAuth(configFromEnv("BUDDY_SELF_URL"));
...
export const authConfig = {
  ...
  // /roster/<token> 的通行碼（名單頁不走 SSO，見 app/roster）。
